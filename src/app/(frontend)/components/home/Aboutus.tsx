...
//     <section
//       id="about"
//       className="w-full xl:pt-32 md:pt-28 pt-8 bg-white
// "
//     >
//       <div className="responsive grid grid-cols-1 lg:grid-cols-2 sm:gap-16 gap-8 sm:items-start items-center opacity-10 hover:opacity-100 transition-all duration-500 cursor-pointer">
...
//                   alt="Hover Image"
//                   fill
//                   className=" transform -translate-x-10 group-hover:translate-x-0 transition-transform duration-700"
//                 />
//               </div>
//             </div>
//           </div>
...
//   opacity-0 -translate-x-10 animate-[slideInRight_1s_ease-out_forwards] delay-[300ms]"
//         >
