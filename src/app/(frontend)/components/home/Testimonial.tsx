...
//                   <p className="text-black font-medium md:mt-10 mt-2 md:ml-12 ml-2 text-sm md:text-base md:leading-7 leading-6 w-full max-w-2xl">
...
//                       <span key={i} className="text-orange-500 md:text-4xl text-3xl gap-2">
//                         ★
//                       </span>
//                     ))}
//                   </div>
...
//         <div className="flex md:justify-center justify-between items-center md:gap-36  md:mt-10 mt-6 md:px-0 px-4">
//           <button className="prev-btn text-green-800 text-4xl  transition">❮</button>
...
//           <button className="next-btn text-green-800 text-4xl transition">❯</button>
//         </div>
//       </div>
//     </section>
//   )
            ...
            <SwiperSlide key={item.id}>
              <div className="flex flex-col md:h-80 h-[600px] items-center justify-center mt-3 md:flex-row gap-8 relative">
                ...
                <div className="flex-1 relative text-center items-center justify-center">
                  ...
                  {/* TEXT ANIMATION — runs only when visible AND correct slide */}
                  <motion.p
                    variants={textParent}
                    initial="hidden"
                    animate={
                      inView && activeIndex === index ? "show" : "hidden"
                    }
