...
export default function Projects() {
  ...
  if (isEmpty) {
    return (
      ...
      >
        <div className="responsive">
          <h2 className="text-xl md:text-3xl font-medium tracking-wide mb-3">OUR RECENT PROJECTS</h2>
          <div className="w-24 h-[2px] bg-yellow-500 mt-3 mb-5"></div>
  ...
  return (
    ...
    >
      ...
      {/* carousel */}
      <div className="relative w-full flex justify-center items-center lg:h-[420px] md:h-96 h-60 
