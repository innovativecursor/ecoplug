        ...
        >
          ...
          <a href="#contact">
            <motion.button
              ...
              className="bg-[#0d5b27] border border-[#0d5b27] rounded-sm xl:w-52 xl:mt-8 mt-2 md:mt-5 text-white xl:h-12 md:h-9 md:w-48 w-36
           p-1 font-medium xl:text-base md:text-sm text-[9px] hover:bg-black hover:text-white transition-all"
            >
