...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "projects_key_highlights" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "hero" (
  	...
  	"projects_completed" numeric NOT NULL,
  	"client_satisfaction" numeric NOT NULL,
  	"updated_at" timestamp(3) with time zone,
  	"created_at" timestamp(3) with time zone
  );
  ...
  ALTER TABLE "projects_key_highlights" ADD CONSTRAINT "projects_key_highlights_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."projects"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "projects_key_highlights_order_idx" ON "projects_key_highlights" USING btree ("_order");
  CREATE INDEX "projects_key_highlights_parent_id_idx" ON "projects_key_highlights" USING btree ("_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "projects_key_highlights" CASCADE;
